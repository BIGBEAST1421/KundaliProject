    ...
    <main>
      ...
      <section className="sky">
        <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 pb-20 pt-16 sm:px-6 md:grid-cols-[1.1fr_0.9fr] md:pt-24">
          <Reveal stagger={0.1} once>
            ...
            <RevealItem as="p" className="mt-4 text-sm text-muted">{t("hero_note")}</RevealItem>
          </Reveal>
      ...
      <section className="border-t border-line bg-surface">
        <div className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
          ...
          <Reveal as="ol" stagger={0.12} className="mt-10 grid gap-8 md:grid-cols-3">
            {([1, 2, 3] as const).map((n) => (
              <RevealItem key={n} as="li" className="flex gap-4">
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        <div className="grid items-center gap-10 md:grid-cols-2">
          ...
          <Reveal delay={0.15}><HoverLift className="rounded-[var(--radius-card)] border border-line p-6 shadow-card">
      ...
      <section className="border-y border-line bg-surface">
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-20 sm:px-6 md:grid-cols-2">
          ...
          <Reveal delay={0.15} className="md:order-1"><HoverLift className="rounded-[var(--radius-card)] border border-line bg-bg p-6 shadow-card">
      ...
      <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
        ...
        <Reveal stagger={0.08} className="mt-10 grid gap-x-12 gap-y-8 sm:grid-cols-2">
          {([1, 2, 3, 4] as const).map((n) => (
            <RevealItem key={n} className="border-t border-line pt-5">
      ...
      <section className="mx-auto max-w-3xl px-4 pb-8 sm:px-6">
        <Reveal className="rounded-[var(--radius-card)] bg-surface p-8 text-center">
